...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/(user)//weddingPackage/': RouteRecordInfo<'/(user)//weddingPackage/', '/weddingPackage', Record<never, never>, Record<never, never>>,
    '/(user)//weddingPackage/[id]/': RouteRecordInfo<'/(user)//weddingPackage/[id]/', '/weddingPackage/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    '/(user)//weddingPackage/create': RouteRecordInfo<'/(user)//weddingPackage/create', '/weddingPackage/create', Record<never, never>, Record<never, never>>,
